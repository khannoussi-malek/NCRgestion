<?php namespace App\Http\Controllers;
	...
	class AdminReport22Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        $this->col = [];
			$this->col[] = array("label"=>"Client","name"=>"client" );
		$this->col[] = array("label"=>"Site","name"=>"site" );
		$this->col[] = array("label"=>"Technicien","name"=>"technicien" );
		$this->col[] = array("label"=>"Secretaire","name"=>"secretaire" );
		$this->col[] = array("label"=>"DateDebut","name"=>"dateDebut" );
		$this->col[] = array("label"=>"DateFin","name"=>"dateFin" );
		$this->col[] = array("label"=>"Probleme","name"=>"probleme" );
		...
		$this->form[] = ["label"=>"DateDebut","name"=>"dateDebut","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
		$this->form[] = ["label"=>"DateFin","name"=>"dateFin","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
		...
		$this->form[] = ["label"=>"TypeDeSortie","name"=>"typeDeSortie","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
